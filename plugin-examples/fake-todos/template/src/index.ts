...
class TemplateNode extends NodeBase {
  ...
  getConfig(): NodeConfig {
    return {
      name: "template", // Name e type needs to be the same
      type: "template", // Name e type needs to be the same
  ...
  async execute(node: NodeInput): Promise<NodeReturn> {
    ...
    //     `https://api.github.com/users/${setting.username}/repos`
    //   );
    //   const data = await response.json();
    //   return { ok: true, data };
    // } else if (setting.operation === "getProfile") {
    //   const response = await fetch(
    //     `https://api.github.com/users/${setting.username}`
    //   );
    //   const data = await response.json();
    //   return { ok: true, data };
    ...
    //   try {
    //     const response = await fetch(
    //       `https://api.github.com/repos/${setting.username}/${setting.repoName}`
    //     );
    //     const data = await response.json();
    //     return { ok: true, data };
    //   } catch (error: any) {
